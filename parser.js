...
function dataRecording(link, requestedHour){
    ...
    fetch(link)
        ...
        .then(json => {
            ...
            const query = `
              INSERT INTO khibiny_open_meteo (time, temperature_2m, relativehumidity_2m, dewpoint_2m, apparent_temperature,
